module.exports = class Data1719482659602 {
    name = 'Data1719482659602'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "token_id" numeric NOT NULL, "owner" text, "ownership_contract_id" character varying, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "laos_asset" ("id" character varying NOT NULL, "token_id" numeric NOT NULL, "initial_owner" text NOT NULL, "laos_contract_id" character varying, "metadata_id" character varying, CONSTRAINT "PK_b922ae1a317644c470a64c7174f" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_7e548aad771e6f5660ebf2f4f8" ON "laos_asset" ("laos_contract_id") `)
        await db.query(`CREATE INDEX "IDX_997503452e3349550aa48cef05" ON "laos_asset" ("metadata_id") `)
        await db.query(`CREATE TABLE "laos_contract" ("id" character varying NOT NULL, CONSTRAINT "PK_51d8bda55eef331253960048499" PRIMARY KEY ("id"))`)
        ...
        await db.query(`ALTER TABLE "laos_asset" ADD CONSTRAINT "FK_7e548aad771e6f5660ebf2f4f8d" FOREIGN KEY ("laos_contract_id") REFERENCES "laos_contract"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_7e548aad771e6f5660ebf2f4f8"`)
        await db.query(`DROP INDEX "public"."IDX_997503452e3349550aa48cef05"`)
        await db.query(`DROP TABLE "laos_contract"`)
        ...
        await db.query(`ALTER TABLE "laos_asset" DROP CONSTRAINT "FK_7e548aad771e6f5660ebf2f4f8d"`)
