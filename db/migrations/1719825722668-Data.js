module.exports = class Data1719825722668 {
    name = 'Data1719825722668'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "laos_asset" ("id" character varying NOT NULL, "laos_contract" text NOT NULL, "token_id" numeric NOT NULL, "initial_owner" text NOT NULL, "metadata_id" character varying, CONSTRAINT "PK_b922ae1a317644c470a64c7174f" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_997503452e3349550aa48cef05" ON "laos_asset" ("metadata_id") `)
        ...
        await db.query(`ALTER TABLE "laos_asset" ADD CONSTRAINT "FK_997503452e3349550aa48cef056" FOREIGN KEY ("metadata_id") REFERENCES "metadata"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    }
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_997503452e3349550aa48cef05"`)
        ...
        await db.query(`ALTER TABLE "laos_asset" DROP CONSTRAINT "FK_997503452e3349550aa48cef056"`)
    }
}
